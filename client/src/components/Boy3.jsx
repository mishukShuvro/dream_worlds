...
Command: npx gltfjsx@6.2.15 public/models/boy3.glb -o src/components/Boy3.jsx -r public 
*/

import React, { useRef } from 'react'
import { useGLTF, useAnimations } from '@react-three/drei'

export function Boy3(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/models/boy3.glb')
